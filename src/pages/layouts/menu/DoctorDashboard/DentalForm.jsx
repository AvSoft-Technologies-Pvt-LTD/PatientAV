...
const DENTAL_POSITIONS = [
 ...
 const DentalForm = ({ data, onSave, onPrint, patient }) => {
  ...
  const handleAddPlan = () => {
    ...
    toast.success(':white_check_mark: Dental plan added successfully!', {
      position: 'top-right',
      autoClose: 2000,
    });
  };
  const handleRemovePlan = (idx) => {
    ...
    toast.success(':white_check_mark: Dental plan removed successfully!', {
      position: 'top-right',
      autoClose: 2000,
    });
  };
  const handleSave = () => {
    onSave('dental', { plans });
    toast.success(':white_check_mark: Dental problem action plan saved!', {
      position: 'top-right',
      autoClose: 2000,
    });
  };
